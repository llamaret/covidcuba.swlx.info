...
$.walker = {
    ...
    view: {
        ...
        update: function () {
            ...
            let $generals = $('#recdist, #deadist, #tesmade-pcr, #tesacum, #topprov, #compari, #paises, #noshow, #topn-n-countries, #evomade, #proscurves, #testspor, #stringencycub, #casinfo');
            if (general_view) {
...
function run_calculations() {
    ...
    $.walker.load("assets/data/oxford-indexes.json", function (oxford_index) {
								...
								grid: {
									x: {
										lines: [
											...
											{'value': '04/11' , 'text': 'Cese de transporte público'}
										]
									}
								}
                        });
